...
if (!$async){
	...
	<article class="article-main article-design article-list">
		<?php if ($async){?>
		...
		<section id="gallery" class="clearfix gallery-design">
		<?php
			$alt = -1;
			$backCol = 1;
			...
			?>
			<div class="gallery-fig <?php echo ' backcolor'.$backCol; echo $classType; if($alt < 0){ echo ' alt';}?>">
				<div class="wrap clearfix design-pod soft-light slg-bottom">
